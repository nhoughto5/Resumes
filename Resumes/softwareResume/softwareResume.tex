...
%	\vspace*{-5mm}
	...
	\resumeSubItem{\link{https://github.com/nhoughto5/OpenGLRenderer}{OpenGLRenderer}, \&  \link{https://github.com/nhoughto5/NeatoVulkanRenderer}{Vulkan Renderer}}{}
	\begin{multicols}{2}
		\begin{itemize}
			\setlength\itemsep{0em}
%			\item Cross platform game engine.
%			\item Both OpenGL and Vulkan Renderer
%			\item Advanced rendering techniques
			\item Modern graphics APIs
			\item Shadow Mapping
			\item Instancing
			\item Blinn-Phong Lighting
			\item OBJ Model Pre-processing
			\item XML Scene Definition
		\end{itemize}	
	\end{multicols}
	\vspace*{-5mm}
...
%		\begin{itemize}
%			\setlength\itemsep{0em}
%			\item Android, iOS \& React Native development
%			\item OpenGL ES
%		\end{itemize}	
%	\end{multicols}
...
%	\vspace*{-5mm}
	...
	{Software Engineer: UFC Mobile 2, FIFA Mobile}{August 2018 - present}
	\begin{itemize}
		\setlength\itemsep{0em}
		\item Graphics pipeline development with OpenGL, mobile engine development and maintenance
		\item Developed and maintained client application with Haxe and C++
		\item Created, led and managed a rendering special interest group for all EA sports mobile
